Locales['en'] = {
  ...
  ['dealer_boss']             = 'aircraft Dealer - Boss',
  ...
  ['rent_vehicle']            = 'aircraft Dealer - Vehicles for rent',
  ['return_provider_menu']    = 'aircraft Dealer - Return vehicle to provider',
  ...
  ['generic_shopitem']        = '$%s',
  ['vehicle_dealer']          = 'vehicle - aircraft Dealer',
  ...
  ['customer_model']          = 'aircraft model',
  ['customer_plate']          = 'aircraft plate',
